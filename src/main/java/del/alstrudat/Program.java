...
public class Program {
    ...
    public static void solve(int n, String[][] soldiersData) {
        ...
        for (int k = 0; k < reportIdx; k++) {
            ...
            // FIX: use floor-truncation (not HALF_UP rounding) to match expected output
            double truncated = Math.floor(r.score * 100) / 100.0;
            System.out.printf(Locale.US, "%s %s %.2f %d\n", r.name, r.status, truncated, r.soldierCount);
